...
SAMPLE_TOPSOIL_PROPERTIES_DATA_URI = (
    "/gws/ssde/j25b/eds_ai/frame-fm/data/inputs/model_estimates_of_topsoil_pH_and_bulk_density/properties"
)
...
class TopsoilDataset(BaseShapefileDataset):
    ...
    def __init__(
        ...
        super().__init__(data_uri=data_uri, transforms=transforms, override_transforms=override_transforms)


if __name__ == "__main__":
    dataset = TopsoilDataset(data_uri=SAMPLE_TOPSOIL_CARBON_DATA_URI)
    ...
    print("----------------------------------")
    dataset = TopsoilDataset(data_uri=SAMPLE_TOPSOIL_PROPERTIES_DATA_URI)
