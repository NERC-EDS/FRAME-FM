...
# load relevant modules from FRAME_FM
from FRAME_FM.dataloaders.demo_geotiff_dataloader import XarrayStaticDataModule
from FRAME_FM.models.demo_convAE import ConvAutoencoder
...
def main(cfg: DictConfig):
    ...
    #Load Datamodule and Model - should they be set up in the same way and just
    #take config files in?
