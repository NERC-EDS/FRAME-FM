...
def test_qc_mask_all_flags():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan],
        equal_nan=True,
    )
...
def test_qc_mask_missing():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, math.nan, 316.6, 316.5, 313.0, 316.8, 323.6, math.nan, math.nan],
        equal_nan=True,
    )
...
def test_qc_mask_no_flags():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, 329.4, 316.6, 316.5, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
...
def test_flags_all():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [math.nan, math.nan, math.nan, math.nan, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
...
def test_flags_u():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [math.nan, 329.4, 316.6, 316.5, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
...
def test_flags_i():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, math.nan, 316.6, 316.5, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
...
def test_flags_e():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, 329.4, math.nan, 316.5, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
...
def test_flags_m():
    ...
    assert np.array_equal(
        ds[0]["TDT1_VWC"].values,
        [339.4, 329.4, 316.6, math.nan, 313.0, 316.8, 323.6, 336.2, 324.0],
        equal_nan=True,
    )
