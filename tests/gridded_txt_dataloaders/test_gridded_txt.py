...
def hydra_config_fixture():
    ...
    class LoggingConfigEurosat:
        ...
        tags: list = field(
            default_factory=lambda: [{"project": "FRAME-FM"}, {"dataset": "EuroSAT"}, {"model": "EuroSAT Autoencoder"}]
        )
    ...
    class HydraConfig:
        ...
        job: list = field(default_factory=lambda: [{"name": "test-EuroSAT"}, {"chdir": "False"}])
