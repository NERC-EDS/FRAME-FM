...
including race, ethnicity, caste, colour, age, physical characteristics,
...
community's expectations for positive behaviour. We also understand that our words and
...
threats, and promotion of these behaviours are violations of this Code of Conduct.
...
4. **Sexualisation.** Behaving in a way that would generally be considered inappropriately intimate
...
4. **Irresponsible communication.** Failing to responsibly present content which includes, links or describes any
   other restricted behaviours.

## Reporting an Issue

Tensions can occur between community members even when they are trying their
best to collaborate. Not every conflict represents a code of conduct violation, and
this Code of Conduct reinforces encouraged behaviours and norms that can help
avoid conflicts and minimise harm.

When an incident does occur, it is important to report it promptly. To report a
possible violation, please use the
[FRAME-FM GitHub Discussions](https://github.com/British-Oceanographic-Data-Centre/FRAME-FM/discussions)
...
and enforcement actions as transparent as possible while prioritising safety and
confidentiality. In order to honour these values, enforcement actions are carried
...
2. **Consequence:** A private written warning with conditions for return from
   ...
   reflect upon their behaviour and possible corrective actions.
...
2. **Consequence:** Access to all community spaces, tools, and communication channels
   ...
   remedies has failed to change the behaviour.
3. **Repair:** There is no possible repair in cases of this severity.

This enforcement ladder is intended as a guideline. It does not limit the
ability of Community Moderators to use their discretion and judgement, in keeping with
...
Contributor Covenant is stewarded by the Organisation for Ethical Source and
