...
1. **Automated contributions.** Submitting code, pull requests, issues, or other contributions via bots or fully automated AI/LLM agents without prior approval from project maintainers.
2. **Unreviewed AI output.** Contributing AI-generated code, documentation, or other content without meaningful human review and verification.
3. **Undisclosed AI use.** Failing to disclose that a contribution was substantially generated by AI/LLM tools.
4. **Harmful AI use.** Using AI/LLM tools to generate misleading, discriminatory, or harmful content, or to circumvent community guidelines.
